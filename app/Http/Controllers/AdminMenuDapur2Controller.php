...
use Carbon\Carbon;
use App\Repositories\TrxOrdersRepository2;		
class AdminMenuDapur2Controller extends CBController {


    public function cbInit()
    {
        $this->setTable("menus");
        $this->setPermalink("menu_dapur_2");
	...
	public function getIndexx(){
        ...
        $data['menu_regular'] = TrxOrdersRepository2::listMenuDapur('Regular',$date);
        $data['menu_propack'] = TrxOrdersRepository2::listMenuDapur('Propack',$date);
